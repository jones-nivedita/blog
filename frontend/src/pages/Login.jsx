      ...
      <div className='shadow-lg p-10'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='flex justify-center mt-10'>
             <button type='submit' className='bg-lavender text-white rounded-lg py-2 px-2 text-sm lg:text-md font-semibold hover:bg-dark-lavender transition-colors duration-300'>Login</button>
          </div>
